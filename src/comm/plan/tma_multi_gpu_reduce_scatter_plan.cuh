...
__host__ __device__ __forceinline__ bool multi_gpu_reduce_scatter_use_fast_copy(
    comm::ReduceScatterPlanKind plan_kind) {
    return plan_kind == comm::ReduceScatterPlanKind::SeqFastAddGmem;
}
...
bool build_tma_multi_gpu_reduce_scatter_naive_plan(
    ...
    *out_num_blocks = 0;
    ...
    const comm::ReduceScatterPlanKind plan_kind =
        comm::reduce_scatter_plan(launch_config);
